...
package SDL.Hints is
   ...
   function Get_Boolean
     (Name    : in String;
      Default : in Boolean := False) return Boolean with
     Inline => True;
   ...
   procedure Set (Name : in String; Value : in String) with
     Inline => True;
   ...
   procedure Set
     (Name     : in String;
      Value    : in String;
      Priority : in Priorities) with
     Inline => True;

   procedure Set (Name : in Hint; Value : in String; Priority : in Priorities) with
     Inline => True;

   function Clear (Name : in String) return Boolean with
     Inline => True;

   function Clear (Name : in Hint) return Boolean with
     Inline => True;
