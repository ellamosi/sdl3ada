...
package body Scaling_Textures_App is
   ...
   begin
      ...
      SDL.Video.Renderers.Makers.Create
        (Window   => App.Window,
         Rend     => App.Renderer,
         Title    => "examples/renderer/scaling-textures",
   ...
   begin
      ...
      Dst_Rect.Width := Float (App.Texture_Size.Width) + (Float (App.Texture_Size.Width) * Scale);
      Dst_Rect.Height := Float (App.Texture_Size.Height) + (Float (App.Texture_Size.Height) * Scale);
      Dst_Rect.X := (Float (Window_Width) - Dst_Rect.Width) / 2.0;
      Dst_Rect.Y := (Float (Window_Height) - Dst_Rect.Height) / 2.0;
      ...
      if Exit_Code /= 0 then
         ...
         begin
            ...
            raise Program_Error with
              "scaling_textures exited with status"
